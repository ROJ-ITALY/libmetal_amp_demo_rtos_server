...
set psu_pll_init_data {
    ...
    mask_write 0XFF5E0034 0xFE7FEDEF 0x7E60EC6C
		# : UPDATE FB_DIV
    ...
    mask_write 0XFF5E0030 0x00717F00 0x00013000
		# : BY PASS PLL
		# Register : RPLL_CTRL @ 0XFF5E0030</p>
...
set psu_clock_init_data {
    ...
    mask_write 0XFF5E004C 0x023F3F07 0x02031900
		...
		# 6 bit divider
		# PSU_CRL_APB_QSPI_REF_CTRL_DIVISOR0                                              0x4

		# 000 = IOPLL; 010 = RPLL; 011 = DPLL; (This signal may only be toggled af
    # ter 4 cycles of the old clock and 4 cycles of the new clock. This is not
    #  usually an issue, but designers must be aware.)
		# PSU_CRL_APB_QSPI_REF_CTRL_SRCSEL                                                0x2

		# This register controls this reference clock
		#(OFFSET, MASK, VALUE)      (0XFF5E0068, 0x013F3F07U ,0x01010402U)  */
    mask_write 0XFF5E0068 0x013F3F07 0x01010402
    ...
    mask_write 0XFF5E006C 0x013F3F07 0x01010402
    ...
    mask_write 0XFF5E0070 0x013F3F07 0x01010402
    ...
    mask_write 0XFF5E009C 0x01003F07 0x01000300
    ...
    mask_write 0XFF5E00C0 0x013F3F07 0x01010802
		...
		# 6 bit divider
		# PSU_CRL_APB_PL1_REF_CTRL_DIVISOR0                                               0x10
    ...
    #  usually an issue, but designers must be aware.)
		...
		# This register controls this reference clock
		#(OFFSET, MASK, VALUE)      (0XFF5E00C4, 0x013F3F07U ,0x01011002U)  */
    mask_write 0XFF5E00C4 0x013F3F07 0x01011002
		# Register : AMS_REF_CTRL @ 0XFF5E0108</p>
...
set psu_ddr_init_data {
    ...
    # d. Unit: Clocks.
		# PSU_DDRC_RFSHTMG_T_RFC_MIN                                                      0x9c

		# Refresh Timing Register
		#(OFFSET, MASK, VALUE)      (0XFD070064, 0x0FFF83FFU ,0x0092809CU)  */
    mask_write 0XFD070064 0x0FFF83FF 0x0092809C
    ...
    # t care'.
		# PSU_DDRC_CRCPARCTL1_ALERT_WAIT_FOR_SW                                           0x0
    ...
    # SHCTL3.dis_auto_refresh = 1)
		# PSU_DDRC_CRCPARCTL1_CRC_PARITY_RETRY_ENABLE                                     0x1
    ...
    # AM's parity detection is enabled, this register should be 1.
		# PSU_DDRC_CRCPARCTL1_PARITY_ENABLE                                               0x1

		# CRC Parity Control Register1
		#(OFFSET, MASK, VALUE)      (0XFD0700C4, 0x3F000391U ,0x10000101U)  */
    mask_write 0XFD0700C4 0x3F000391 0x10000101
    ...
    # only.
		# PSU_DDRC_INIT6_MR5                                                              0x6c2

		# SDRAM Initialization Register 6
		#(OFFSET, MASK, VALUE)      (0XFD0700E8, 0xFFFFFFFFU ,0x000006C2U)  */
    mask_write 0XFD0700E8 0xFFFFFFFF 0x000006C2
    ...
    # r value. Unit: Clocks.
		...
		#(OFFSET, MASK, VALUE)      (0XFD070104, 0x001F1F7FU ,0x0007041CU)  */
    mask_write 0XFD070104 0x001F1F7F 0x0007041C
    ...
    # TMG1 are sufficient for those protocols Unit: clocks
		# PSU_DDRC_DRAMTMG2_WRITE_LATENCY                                                 0x9
    ...
    # : clocks
		# PSU_DDRC_DRAMTMG2_READ_LATENCY                                                  0xb
    ...
    #  next integer.
		# PSU_DDRC_DRAMTMG2_WR2RD                                                         0x12

		# SDRAM Timing Register 2
		#(OFFSET, MASK, VALUE)      (0XFD070108, 0x3F3F3F3FU ,0x090B0812U)  */
    mask_write 0XFD070108 0x3F3F3F3F 0x090B0812
    ...
    # pplied to mode register writes by the RDIMM chip.
		# PSU_DDRC_DRAMTMG3_T_MOD                                                         0xf

		# SDRAM Timing Register 3
		#(OFFSET, MASK, VALUE)      (0XFD07010C, 0x3FF3F3FFU ,0x0050F00FU)  */
    mask_write 0XFD07010C 0x3FF3F3FF 0x0050F00F
    ...
    # round it up to the next integer value. Unit: Clocks.
		...
		#(OFFSET, MASK, VALUE)      (0XFD070114, 0x0F0F3F1FU ,0x06090403U)  */
    mask_write 0XFD070114 0x0F0F3F1F 0x06090403
    ...
    #  designs supporting mDDR or LPDDR2/LPDDR3/LPDDR4 devices.
		...
		#(OFFSET, MASK, VALUE)      (0XFD07011C, 0x00000F0FU ,0x00000906U)  */
    mask_write 0XFD07011C 0x00000F0F 0x00000906
    ...
    # by 2, and round it up to next integer.
		# PSU_DDRC_DRAMTMG9_WR2RD_S                                                       0xf

		# SDRAM Timing Register 9
		#(OFFSET, MASK, VALUE)      (0XFD070124, 0x40070F3FU ,0x0002040FU)  */
    mask_write 0XFD070124 0x40070F3F 0x0002040F
    ...
    # ion by 2, and round it up to next integer.
		...
		#(OFFSET, MASK, VALUE)      (0XFD07012C, 0x7F1F031FU ,0x1208010EU)  */
    mask_write 0XFD07012C 0x7F1F031F 0x1208010E
    ...
    # the extra cycle of latency through the RDIMM. Unit: Clocks
		# PSU_DDRC_DFITMG0_DFI_T_RDDATA_EN                                                0x12
    ...
    # ycle of latency through the RDIMM.
		# PSU_DDRC_DFITMG0_DFI_TPHY_WRLAT                                                 0xe

		# DFI Timing Register 0
		#(OFFSET, MASK, VALUE)      (0XFD070190, 0x1FBFBF3FU ,0x0492820EU)  */
    mask_write 0XFD070190 0x1FBFBF3F 0x0492820E
    ...
    # cification for correct value.
		# PSU_DDRC_DFITMG2_DFI_TPHY_RDCSLAT                                               0x10
    ...
    # cification for correct value.
		# PSU_DDRC_DFITMG2_DFI_TPHY_WRCSLAT                                               0xc

		# DFI Timing Register 2
		#(OFFSET, MASK, VALUE)      (0XFD0701B4, 0x00003F3FU ,0x0000100CU)  */
    mask_write 0XFD0701B4 0x00003F3F 0x0000100C
    ...
    # QS/DQS# rising edge.
		...
		# PSU_DDR_PHY_DTPR1_TMRD                                                          0x1e

		# DRAM Timing Parameters Register 1
		#(OFFSET, MASK, VALUE)      (0XFD080114, 0xFFFFFFFFU ,0x2824051EU)  */
    mask_write 0XFD080114 0xFFFFFFFF 0x2824051E
    ...
    mask_write 0XFD08011C 0xFFFFFFFF 0x83000800
		...
		# PSU_DDR_PHY_DTPR4_TXP                                                           0xd

		# DRAM Timing Parameters Register 4
		#(OFFSET, MASK, VALUE)      (0XFD080120, 0xFFFFFFFFU ,0x01382B0DU)  */
    mask_write 0XFD080120 0xFFFFFFFF 0x01382B0D
    ...
    mask_write 0XFD080124 0xFFFFFFFF 0x00381109
		...
		# Write Latency
		# PSU_DDR_PHY_DTPR6_PUBWL                                                         0x11

		# Reserved. Return zeroes on reads.
		# PSU_DDR_PHY_DTPR6_RESERVED_7_6                                                  0x0

		# Read Latency
		# PSU_DDR_PHY_DTPR6_PUBRL                                                         0x16

		# DRAM Timing Parameters Register 6
		#(OFFSET, MASK, VALUE)      (0XFD080128, 0xFFFFFFFFU ,0x00001116U)  */
    mask_write 0XFD080128 0xFFFFFFFF 0x00001116
    ...
    # med to 0x0.
		...
		# PSU_DDR_PHY_MR5_CAPM                                                            0x2

		# DDR4 Mode Register 5
		#(OFFSET, MASK, VALUE)      (0XFD080194, 0xFFFFFFFFU ,0x000006C2U)  */
    mask_write 0XFD080194 0xFFFFFFFF 0x000006C2
...
set psu_mio_init_data {
    ...
    #  MIO Bank 0 - control MIO[25:0]
		#(OFFSET, MASK, VALUE)      (0XFF180144, 0x03FFEFFFU ,0x03FFEFFFU)  */
    mask_write 0XFF180144 0x03FFEFFF 0x03FFEFFF
    ...
    # own for MIO Bank 0 - control MIO[25:0]
		#(OFFSET, MASK, VALUE)      (0XFF180148, 0x03FFFFFFU ,0x03FFEFFFU)  */
    mask_write 0XFF180148 0x03FFFFFF 0x03FFEFFF
...
set psu_serdes_init_data {
    ...
    # 2 - Sata1, 3 - USB1, 4 - DP.0, 5 - SGMII3, 6 - Unused, 7 - Unused
		...
		#(OFFSET, MASK, VALUE)      (0XFD410014, 0x00000070U ,0x00000030U)  */
    mask_write 0XFD410014 0x00000070 0x00000030
		# : CHECKING PLL LOCK
